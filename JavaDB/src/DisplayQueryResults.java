...
public class DisplayQueryResults extends JFrame 
{
   ...
   static final String DATABASE_URL = "jdbc:mysql://localhost:3306/project3";
   ...
   {   
     ...
     // center.add(centerP1, BorderLayout.WEST);
     // center.add(centerP2, BorderLayout.EAST);
      ...
      connect.addActionListener(new ActionListener(){
    		...
    		public void actionPerformed(ActionEvent e){
    			...
    			if(PWField.toString() == null || PWField.toString() == ""){
    				password = PASSWORD;
    			}
    			else{
    			...
    			tableModel = new ResultSetTable( JDBC_DRIVER, DATABASE_URL,username, password, DEFAULT_QUERY );
